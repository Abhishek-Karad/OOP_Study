...
//main interface for walking 
class WalkableRobot{
    public:
    virtual void walk()=0;//open to be used in polymorphism
...
//main interface for talking 
class TalkableRobot{
    public:
    virtual void talk()=0;//open to be used in polymorphism
